...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To KitanarTunnel ${YELLOW}(${NC}${green} Stabil Edisi ${NC}${YELLOW})${NC}"
echo -e " Ini adalah ssh gratis"
echo -e "  Jangan Lupa Pake${green}Server Gratis Ini${NC}${YELLOW}(${NC} ${green} Kitanar Tunneling ${NC}${YELLOW})${NC}"
echo -e " © Terimkasih Kepada Kalian${YELLOW}(${NC} 2025-2026 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/pevoz/hai/refs/heads/main/asvps1 | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/pevoz/hai/refs/heads/main/asvps1 | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/pevoz/hai/refs/heads/main/asvps1 | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/pevoz/asvps1/refs/heads/main/"
...
clear
    print_install "Core Xray 2.5.1 Latest Version"
    # install xray
...
wget https://raw.githubusercontent.com/pevoz/asvps1/refs/heads/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
...
port 587
auth on
user imskinz6@gmail.com
from imskinz6@gmail.com
password SIAPAKAMU12
logfile ~/.msmtp.log
EOF
